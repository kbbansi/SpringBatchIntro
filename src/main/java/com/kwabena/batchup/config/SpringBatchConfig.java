package com.kwabena.batchup.config;

import com.kwabena.batchup.entity.Customer;
import com.kwabena.batchup.repository.CustomerRepository;
...
public class SpringBatchConfig {
    ...
    private LineMapper<Customer> lineMapper() {
        ...
        delimitedLineTokenizer.setNames("CustomerID", "Genre", "Age", "Annual_Income", "Spending_Score");
